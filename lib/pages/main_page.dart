...
class _MainPageState extends State<MainPage> {
  ...
  final bgColorDisconnected = [Colors.cyan,Color(0xffcccccc), Color(0xFFDD473D)];
  final bgColorConnected = [Colors.cyan,Color(0xffcccccc), Color(0xFF37AC53)];
  final bgColorConnecting = [Colors.cyan,Color(0xffcccccc), Color(0xFFCCAD00)];
              ...
              SizedBox(
                ...
                child: FloatingActionButton(
                  ...
                  child: new Icon(Icons.power_settings_new,
                      size: screenAwareSize(110.0, context)),
                ),
              ),
